...
#include <memory>
#include "../src/Utilities/delegate.h"
...
struct qt_meta_stringdata_NonEditDelegate_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_NonEditDelegate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NonEditDelegate_t qt_meta_stringdata_NonEditDelegate = {
    {
QT_MOC_LITERAL(0, 0, 15) // "NonEditDelegate"
...
static const uint qt_meta_data_NonEditDelegate[] = {
...
void NonEditDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    (void)_o;
    (void)_id;
    (void)_c;
...
QT_INIT_METAOBJECT const QMetaObject NonEditDelegate::staticMetaObject = { {
    QMetaObject::SuperData::link<QItemDelegate::staticMetaObject>(),
    qt_meta_stringdata_NonEditDelegate.data,
    qt_meta_data_NonEditDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *NonEditDelegate::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *NonEditDelegate::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_NonEditDelegate.stringdata0))
        return static_cast<void*>(this);
    return QItemDelegate::qt_metacast(_clname);
}

int NonEditDelegate::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
